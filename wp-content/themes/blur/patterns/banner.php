...
return array(
    ...
    'content'    => '<!-- wp:group {"tagName":"main","style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"},"border":{"bottom":{"width":"0px","style":"none"}}},"layout":{"type":"constrained"}} -->
    <main class="wp-block-group" style="border-bottom-style:none;border-bottom-width:0px;margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0"><!-- wp:cover {"url":"' . esc_url( BLUR_URL . 'assets/images/').'bg.png","id":708,"hasParallax":true,"isRepeated":true,"dimRatio":90,"overlayColor":"primary","align":"full"} -->
    ...
    <!-- wp:heading {"textAlign":"center","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"textColor":"background","fontSize":"extra-large"} -->
    <h2 class="has-text-align-center has-background-color has-text-color has-extra-large-font-size" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">'.esc_html__('your first purchase','blur').'</h2>
    <!-- /wp:heading -->
