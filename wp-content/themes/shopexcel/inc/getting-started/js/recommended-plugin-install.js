(function($){
    GettingStartedThemeAdmin = {
        ...
        _pluginInstalling: function(event, args) {
            ...
            var $card = jQuery( '.install-now' );
            var activatingText = shopexcel_start_page.ActivatingText;
        ...
        _activatePlugin: function( event, response ) {
            ...
            var $init            = $message.data('init');
            var activatingText   = shopexcel_start_page.ActivatingText;
            var deactivateText   = shopexcel_start_page.PluginDeactivateText;
            var settingsLink     = $message.data('settings-link');
            var settingsLinkText = shopexcel_start_page.SettingsText;
            var browseText       = shopexcel_start_page.BrowseTemplates;
            ...
            setTimeout( function() {
                ...
                $.ajax({
                    url: shopexcel_start_page.ajaxUrl,
                    type: 'POST',
                    data: {
        ...
        _deactivatePlugin: function( event, response ) {
            ...
            // Transform the 'Install' button into an 'Activate' button.
            var $init            = $message.data('init');
            var deactivatingText = $message.data('deactivating-text') || shopexcel_start_page.DeactivatingText;
            var activateText     = shopexcel_start_page.PluginActivateText;
            var settingsLink     = $message.data('settings-link');
