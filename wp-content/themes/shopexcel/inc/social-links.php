...
class Shopexcel_Social_Lists{
     ...
     * @return void
     */
    public function shopexcel_lists_all_svgs( $social ){
        if( !$social ){
            return;
        }
        switch ( $social ) {
     ...
     * @return void
     */
    public function shopexcel_all_social_icons(){
        $social_array = [ 
            [
                'key' => 'shply_facebook',
                'value' => '#'
        ...
        $social_icons = apply_filters( 'shply_social_icons',$social_array );
     ...
     * @return void
     */
    public function shopexcel_social_links(){
        ...
        $list_social            = $this->shopexcel_all_social_icons();
        ...
        if( $ed_social_media && $social_media_order ){ ?>
                <ul class="social-networks">
                    ...
                    foreach( $social_media_order as $link ){
                        $actualsocialkey = str_replace( 'shply_','',$link );
                            ...
                            if( !empty( $value ) && $key == $link ){
                                ?>
                                    ...
                                    <a href="<?php if( isset( $value ) ) echo esc_url( $value ); ?>" target="<?php echo $ed_social_media_newtab ? '_blank': '_self'; ?>" rel="nofollow noopener">
                                        <?php echo wp_kses( $this->shopexcel_lists_all_svgs( $actualsocialkey ), shopexcel_get_kses_extended_ruleset() ); ?>
                                    </a>
                                </li>  
                                <?php 
                            }
